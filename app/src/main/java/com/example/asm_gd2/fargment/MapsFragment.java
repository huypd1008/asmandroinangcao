                ...
                try {
                    ...
                    Marker danang = mMap.addMarker(
                            new MarkerOptions()
                                    .position(toado)
                                    .title("Fpoly HCM CS1")
                                    .snippet("Cao đẳng thực hành FPT Polytechnic cơ sở 1 xin chào!")
                ...
                try {
                    ...
                    Marker danang = mMap.addMarker(
                            new MarkerOptions()
                                    .position(toado)
                                    .title("Fpoly HCM CS2")
                                    .snippet("Cao đẳng thực hành FPT Polytechnic cơ sở 2 xin chào!")
                                    .icon(BitmapDescriptorFactory.defaultMarker(
                ...
                try {
                    ...
                    Marker TayNguyen = mMap.addMarker(
                            new MarkerOptions()
                                    .position(toado)
                                    .title("Fpoly HCM CS3")
                                    .snippet("Cao đẳng thực hành FPT Polytechnic cơ sở 3 xin chào!")
